...
<!--        </el-menu-item>-->
    ...
    <el-container>
      <el-header>
        <span style="font-size: 20px;line-height: 60px">食品生鲜溯源系统-生产商</span>
      ...
      <el-main v-show="index == 2">
        ...
        <el-dialog title="创建食品订单" :visible.sync="dialogFormVisible_1" append-to-body>
          <el-form :model="order_get_id" label-width="90px" style="width: 400px;margin: 0 auto">
            <el-form-item label="食品种类">
              <el-input v-model="order_get_id.feedType"></el-input>
            </el-form-item>
            <el-form-item label="食品名称">
              <el-input v-model="order_get_id.name"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="get_id">下一步</el-button>
            </el-form-item>
          </el-form>
        </el-dialog>
        <el-dialog title="填写生产者信息" :visible.sync="dialogFormVisible_2" append-to-body>
          <el-form :model="producers" label-width="90px" style="width: 400px;margin: 0 auto">
            <el-form-item label="订单编号">
              <span>{{producers.id}}</span>
            </el-form-item>
            <el-form-item label="食品名称">
              <span>{{producers.feedname}}</span>
            </el-form-item>
            <el-form-item label="公司">
              <el-input v-model="producers.company"></el-input>
            </el-form-item>
            <el-form-item label="负责人">
              <el-input v-model="producers.people"></el-input>
            </el-form-item>
            <el-form-item label="联系电话">
              <el-input v-model="producers.phone"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="producers_order">提交订单</el-button>
            </el-form-item>
          </el-form>
        </el-dialog>
        <el-table :data="tableData" border width="100%">
          <el-table-column prop="id" label="ID" width="100"></el-table-column>
          <el-table-column prop="feedname" label="食品名称" width="190"></el-table-column>
          <el-table-column prop="company" label="公司" width="190"></el-table-column>
...
name: "production",
  ...
  methods:{
    ...
    get_id(){
      let data = {
        username :this.username,
        name : this.order_get_id.name,
        feedType : this.order_get_id.feedType
      }
      this.axios.post('/get_id',data)
      .then((res)=>{
        this.producers.id = res.data.data.id
        this.producers.feedname = res.data.data.feedname
      })
      .catch((res)=>{
        console.log(res);
      })
    ...
    producers_order(){
      let data = {
        ...
        feedname: this.producers.feedname,
        company: this.producers.company,
        people: this.producers.people,
        phone : this.producers.phone
      }
      this.axios.post('/producers_order',data)
      .then((res)=>{
        console.log(res);
        if (res.data.code == 200){
    ...
    menu2(){
      ...
      this.index = 2
      this.tableData = []
      this.axios.post('get_producers_order',data)
      .then((res)=>{
        console.log(res);
