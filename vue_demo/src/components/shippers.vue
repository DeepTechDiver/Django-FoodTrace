    ...
    <el-container>
      ...
      <el-main v-show="index == 2">
        ...
        <el-dialog title="填写生产者信息" :visible.sync="dialogFormVisible_2" append-to-body>
          <el-form :model="shippers" label-width="90px" style="width: 400px;margin: 0 auto">
            <el-form-item label="订单编号">
              <span>{{shippers.id}}</span>
            </el-form-item>
            <el-form-item label="食品名称">
              <span>{{shippers.feedname}}</span>
            </el-form-item>
            <el-form-item label="车号">
              <el-input v-model="shippers.car_num"></el-input>
            </el-form-item>
            <el-form-item label="出发地">
              <el-input v-model="shippers.form_place"></el-input>
            </el-form-item>
            <el-form-item label="目的地">
              <el-input v-model="shippers.to_place"></el-input>
            </el-form-item>
            <el-form-item label="负责人">
              <el-input v-model="shippers.people"></el-input>
            </el-form-item>
            <el-form-item label="联系电话">
              <el-input v-model="shippers.phone"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="shippers_order">提交订单</el-button>
            </el-form-item>
          </el-form>
        </el-dialog>
        <el-table :data="tableData" border width="100%">
          <el-table-column prop="id" label="ID" width="100"></el-table-column>
          <el-table-column prop="car_num" label="车号" width="100"></el-table-column>
          <el-table-column prop="form_place" label="出发地" width="190"></el-table-column>
          <el-table-column prop="to_place" label="目的地" width="190"></el-table-column>
...
export default {
  ...
  methods:{
    ...
    id_info(){
      ...
      this.shippers.id = this.order_id_info.id
      this.axios.post('/get_id_info',data)
          .then((res)=>{
            this.shippers.feedname = res.data.data
          })
          .catch((res)=>{
            console.log(res);
          })
    ...
    shippers_order(){
      let data = {
        username :this.username,
        id : this.shippers.id,
        car_num: this.shippers.car_num,
        form_place: this.shippers.form_place,
        to_place: this.shippers.to_place,
        people: this.shippers.people,
        phone : this.shippers.phone
      }
      this.axios.post('/shippers_order',data)
          .then((res)=>{
            console.log(res);
            if (res.data.code == 200){
    ...
    menu2(){
      ...
      this.index = 2
      this.tableData = []
      this.axios.post('get_shippers_order',data)
          .then((res)=>{
            console.log(res);
